...
if($_SERVER["REQUEST_METHOD"]=="POST"){
  ...
  try{
    ...
    $stmt->execute([$email, $name, $pass, $gender]);
  ...
  <body>
    <div class="main-block">
      ...
      <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
        ...
        <hr>
        <div class="gender">
          <input type="radio" value="1" id="male" name="gender" <?php if (isset($gender) && $gender== true) echo "checked";?>/>
          <label for="male" class="radio">Male</label>
          <input type="radio" value="0" id="female" name="gender" <?php if (isset($gender) && $gender== false) echo "checked";?>/>
